                    ...
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="flex items-center gap-2 text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition bg-gray-100">
                                    <span class="text-sm font-medium text-gray-800 tracking-wider ml-2">{{ Auth::user()->name }}</span>
